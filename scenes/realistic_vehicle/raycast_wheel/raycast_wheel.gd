...
func _ready() -> void:
	...
	if Differed_Wheel_Export:
		differed_wheel_node = Differed_Wheel_Export
	...
	if SwayBarConnection:
		sway_bar_wheel = SwayBarConnection
