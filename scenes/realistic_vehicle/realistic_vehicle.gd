...
const keyboard_mouse_controls:ViVeCarControls = preload("res://scenes/realistic_vehicle/other_class/controls/presets/keyboard_and_mouse.tres")
const keyboard_controls:ViVeCarControls = preload("res://scenes/realistic_vehicle/other_class/controls/presets/keyboard.tres")
const touch_controls:ViVeCarControls = preload("res://scenes/realistic_vehicle/other_class/controls/presets/touch_screen.tres")
const joypad_controls:ViVeCarControls = preload("res://scenes/realistic_vehicle/other_class/controls/presets/joypad.tres")
