...
const keyboard_mouse_controls:ViVeCarControls = preload("res://scenes/vivavehicle_misc/controls config/presets/keyboard_and_mouse.tres")
const keyboard_controls:ViVeCarControls = preload("res://scenes/vivavehicle_misc/controls config/presets/keyboard.tres")
const touch_controls:ViVeCarControls = preload("res://scenes/vivavehicle_misc/controls config/presets/touch_screen.tres")
const joypad_controls:ViVeCarControls = preload("res://scenes/vivavehicle_misc/controls config/presets/joypad.tres")
